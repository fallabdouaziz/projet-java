                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Nom de la formation </th>
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" ">Paid</td>
                            <td class="a-right a-right "> <a href="formation-update"><button type="button" class="btn btn-round btn-primary">Modifier</button></a></td>
                            <td class=" last"><a href="#"><button type="button" class="btn btn-round btn-danger">Supprimer</button></td></a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                     <a href="formation-add" style="font-size: 20px;"><i class="fa fa-plus-square"></i> Ajouter une nouvelle formation</a> 
                    </div>
